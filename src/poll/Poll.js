        ...
        return (
            <div className="poll-content">
                    ...
                    <div className="poll-creator-info">
                        <Link className="creator-link" to={`/users/${this.props.poll.createdBy.username}`}>
                            ...
                            <span className="poll-creation-date">
                                {formatDateTime(this.props.poll.creationTime)}
                            </span>
                        </Link>
                    </div>
                ...
                <div className="poll-footer">
                    ...
                    <span className="total-votes">{this.props.poll.currentVotes} votes</span>
                    <span className="separator">·</span>
                    <span className="time-left">{
                        this.props.poll.expired ? "Final resulta": this.getTimeRemaining(this.props.poll)
                    }</span>
                </div>
            </div>
        );
    ...
    return (
        <div className="cv-poll-choice">
            <span className="cv-poll-choice-details">
                ...
                {
                    props.isSelected ? (<Icon
                    className="selected-choice-icon"
                    type="check-circle-o"
                    />) : null
                }
            </span>
            <span className={props.isWinner ? 'cv-choice-percent-char winner': 'cv-choice-percent-chart'}
